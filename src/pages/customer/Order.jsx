...
import { FiShoppingCart, FiClock, FiCheckCircle, FiTruck, FiHome, FiCreditCard } from 'react-icons/fi';
                  ...
                  {restaurant.items.map(item => (
                    <div key={item.id} className="flex justify-between items-center mb-3 last:mb-0">
                      ...
                      <div className="flex items-center">
                        <button 
                          onClick={() => updateQuantity(restaurant.restaurantId, item.id, item.quantity - 1)}
                        ...
                        <button 
                          onClick={() => removeFromCart(restaurant.restaurantId, item.id)}
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            ...
            <div className="space-y-3">
              <div className="flex justify-between">
                ...
                <span className="font-medium">Rs. {calculateCartTotal().toFixed(2)}</span>
              </div>
              <div className="flex justify-between">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium">Rs. {(calculateCartTotal() * 0.08).toFixed(2)}</span>
              </div>
              <div className="border-t pt-3 mt-3 flex justify-between">
                <span className="font-semibold text-gray-800">Total</span>
                <span className="font-bold text-lg text-blue-600">
                  Rs. {(calculateCartTotal() + 200 + (calculateCartTotal() * 0.08)).toFixed(2)}
                </span>
              </div>
            </div>
    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="flex space-x-4">
            ...
            >
              ...
              Cart {cart.length > 0 && `(${cart.reduce((sum, r) => sum + r.items.length, 0)})`}
            </button>
            <button 
        ...
        <div className="bg-white rounded-xl shadow-md p-6">
          ...
          {activeTab.startsWith('menu-') && renderRestaurantMenu(activeTab.split('-')[1])}
